# Confluence Auth Proxy

This is a Forge app that acts as an authentication proxy for Confluence webhooks, forwarding events to the Grapevine gatekeeper service.
...
To test the Confluence connector locally with your development environment:
