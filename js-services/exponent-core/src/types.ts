...
/**
 * Meeting transcript document input
 */
...
/**
 * GitHub PR document input
 */
export interface GithubPrDocument {
  ...
  /** PR creation date (ISO 8601) */
  date?: string;

  /** Formatted PR content (description, comments, review comments) */
  content: string;
}
