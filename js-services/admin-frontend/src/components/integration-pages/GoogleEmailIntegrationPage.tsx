...
import { GoogleEmailIntegration } from '../integrations/GoogleEmailIntegration';

const GoogleEmailIntegrationPage: FC = memo(() => {
  const navigate = useNavigate();
  const { integrations } = useIntegrations();

  const integration = integrations.find((int) => int.id === 'google_email');
...
GoogleEmailIntegrationPage.displayName = 'GoogleEmailIntegrationPage';

export { GoogleEmailIntegrationPage };
