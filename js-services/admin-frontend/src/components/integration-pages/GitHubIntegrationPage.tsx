...
const GitHubIntegrationPage: FC = memo(() => {
  const navigate = useNavigate();
  const { integrations } = useIntegrations();

  const integration = integrations.find((int) => int.id === 'github');
...
GitHubIntegrationPage.displayName = 'GitHubIntegrationPage';

export { GitHubIntegrationPage };
