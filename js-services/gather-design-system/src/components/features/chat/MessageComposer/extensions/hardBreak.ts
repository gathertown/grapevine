 ...
 *
 * We've modified it from the source to prevent keyboard shortcuts.
 * Source: https://github.com/ueberdosis/tiptap/blob/main/packages/extension-hard-break/src/hard-break.ts
 */
